...
public:
    ...
    [[nodiscard]] const std::string& getColumnName() const { return column_name_; }
    [[nodiscard]] size_t getColumnIndex() const { return column_index_; }
    [[nodiscard]] bool hasColumnIndex() const { return has_column_index_; }
