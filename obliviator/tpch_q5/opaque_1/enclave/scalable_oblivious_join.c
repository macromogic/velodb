...
void soj_scan_1(void *voidargs) {
    ...
    for (int i = index_start; i < index_end; i++) {
        //cb1[i] = (88 < arr1[i].key);
        the_con = (19940101 <= arr1[i].true_key) && (arr1[i].true_key < 19950101);
...
void scalable_oblivious_join(elem_t *arr, int length1, int length2, char* output_path){
    ...
    if (number_threads == 1) {
        for (int i = 0; i < length1; i++) {
            arr[i].key = 1 - ((19940101 <= arr[i].true_key) * (arr[i].true_key < 19950101));
            length_result += ((19940101 <= arr[i].true_key) * (arr[i].true_key < 19950101));
        }
    } else {
