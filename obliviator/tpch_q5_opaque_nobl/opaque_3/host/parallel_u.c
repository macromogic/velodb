...
static const oe_ecall_info_t _parallel_ecall_info_table[] = 
{
...
oe_result_t parallel_ecall_release_threads(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    ecall_release_threads_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_release_threads_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_release_threads_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (ecall_release_threads_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_release_threads].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (ecall_release_threads_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(parallel_ecall_release_threads, ecall_release_threads);

oe_result_t parallel_ecall_unrelease_threads(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_unrelease_threads_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_unrelease_threads_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_unrelease_threads_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_unrelease_threads_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_unrelease_threads].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_unrelease_threads_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_unrelease_threads, ecall_unrelease_threads);

oe_result_t parallel_ecall_ojoin_init(
    ...
    size_t num_threads)
{
    ...
    /* Marshalling struct. */
    ecall_ojoin_init_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.world_rank = world_rank;
    _args.world_size = world_size;
    _args.num_threads = num_threads;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ojoin_init_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ojoin_init_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ojoin_init_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_ojoin_init].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ojoin_init_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_ojoin_init, ecall_ojoin_init);

oe_result_t parallel_ecall_ojoin_free_arr(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_ojoin_free_arr_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ojoin_free_arr_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ojoin_free_arr_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ojoin_free_arr_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_ojoin_free_arr].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ojoin_free_arr_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_ojoin_free_arr, ecall_ojoin_free_arr);

oe_result_t parallel_ecall_ojoin_free(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_ojoin_free_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ojoin_free_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ojoin_free_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ojoin_free_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_ojoin_free].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ojoin_free_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_ojoin_free, ecall_ojoin_free);

oe_result_t parallel_ecall_start_work(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_start_work_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_start_work_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_start_work_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_start_work_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_start_work].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_start_work_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_start_work, ecall_start_work);

oe_result_t parallel_ecall_scalable_oblivious_join(
    oe_enclave_t* enclave,
    int* _retval,
    char* input_path,
    size_t len)
{
    ...
    /* Marshalling struct. */
    ecall_scalable_oblivious_join_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.input_path = (char*)input_path;
    _args.len = len;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_scalable_oblivious_join_args_t));
    if (input_path)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.len);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_scalable_oblivious_join_args_t));
    if (input_path)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_scalable_oblivious_join_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (input_path)
        OE_WRITE_IN_OUT_PARAM(input_path, 1, _args.len, char*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_scalable_oblivious_join].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_scalable_oblivious_join_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_IN_OUT_PARAM(input_path, 1, _args.len);
...
OE_WEAK_ALIAS(parallel_ecall_scalable_oblivious_join, ecall_scalable_oblivious_join);

oe_result_t parallel_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(parallel_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t parallel_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(parallel_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t parallel_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(parallel_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t parallel_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(parallel_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t parallel_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(parallel_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static void ocall_ocall_mpi_send_bytes(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_mpi_send_bytes_args_t* _pargs_in = (ocall_mpi_send_bytes_args_t*)input_buffer;
    ocall_mpi_send_bytes_args_t* _pargs_out = (ocall_mpi_send_bytes_args_t*)output_buffer;
    ...
    if (_pargs_in->buf)
        OE_SET_IN_POINTER(buf, _pargs_in->count, sizeof(unsigned char), unsigned char*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_mpi_send_bytes(
        (const unsigned char*)_pargs_in->buf,
        _pargs_in->count,
        _pargs_in->dest,
        _pargs_in->tag);
...
static void ocall_ocall_mpi_recv_bytes(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_mpi_recv_bytes_args_t* _pargs_in = (ocall_mpi_recv_bytes_args_t*)input_buffer;
    ocall_mpi_recv_bytes_args_t* _pargs_out = (ocall_mpi_recv_bytes_args_t*)output_buffer;
    ...
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->buf)
        OE_SET_OUT_POINTER(buf, _pargs_in->count, sizeof(unsigned char), unsigned char*);
    if (_pargs_in->status)
        OE_SET_OUT_POINTER(status, 1, sizeof(ocall_mpi_status_t), ocall_mpi_status_t*);

    /* Call user function. */
    _pargs_out->oe_retval = ocall_mpi_recv_bytes(
        _pargs_in->buf,
        _pargs_in->count,
        _pargs_in->source,
        _pargs_in->tag,
...
static void ocall_ocall_mpi_try_recv_bytes(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_mpi_try_recv_bytes_args_t* _pargs_in = (ocall_mpi_try_recv_bytes_args_t*)input_buffer;
    ocall_mpi_try_recv_bytes_args_t* _pargs_out = (ocall_mpi_try_recv_bytes_args_t*)output_buffer;
    ...
    if (_pargs_in->buf)
        OE_SET_OUT_POINTER(buf, _pargs_in->count, sizeof(unsigned char), unsigned char*);
    if (_pargs_in->flag)
        OE_SET_OUT_POINTER(flag, 1, sizeof(int), int*);
    if (_pargs_in->status)
        OE_SET_OUT_POINTER(status, 1, sizeof(ocall_mpi_status_t), ocall_mpi_status_t*);

    /* Call user function. */
    _pargs_out->oe_retval = ocall_mpi_try_recv_bytes(
        _pargs_in->buf,
        _pargs_in->count,
        _pargs_in->source,
        _pargs_in->tag,
...
static void ocall_ocall_mpi_isend_bytes(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_mpi_isend_bytes_args_t* _pargs_in = (ocall_mpi_isend_bytes_args_t*)input_buffer;
    ocall_mpi_isend_bytes_args_t* _pargs_out = (ocall_mpi_isend_bytes_args_t*)output_buffer;
    ...
    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->request)
        OE_SET_OUT_POINTER(request, 1, sizeof(ocall_mpi_request_t), ocall_mpi_request_t*);

    /* Call user function. */
    _pargs_out->oe_retval = ocall_mpi_isend_bytes(
        (const unsigned char*)_pargs_in->buf,
        _pargs_in->count,
        _pargs_in->dest,
        _pargs_in->tag,
...
static void ocall_ocall_mpi_irecv_bytes(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_mpi_irecv_bytes_args_t* _pargs_in = (ocall_mpi_irecv_bytes_args_t*)input_buffer;
    ocall_mpi_irecv_bytes_args_t* _pargs_out = (ocall_mpi_irecv_bytes_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_mpi_irecv_bytes(
        _pargs_in->count,
        _pargs_in->source,
        _pargs_in->tag,
        _pargs_in->request);
...
static void ocall_ocall_mpi_wait(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_mpi_wait_args_t* _pargs_in = (ocall_mpi_wait_args_t*)input_buffer;
    ocall_mpi_wait_args_t* _pargs_out = (ocall_mpi_wait_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->request)
        OE_SET_IN_POINTER(request, 1, sizeof(ocall_mpi_request_t), ocall_mpi_request_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_mpi_wait(
        _pargs_in->buf,
        _pargs_in->count,
        _pargs_in->request,
        _pargs_in->status);
...
static void ocall_ocall_mpi_waitany(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_mpi_waitany_args_t* _pargs_in = (ocall_mpi_waitany_args_t*)input_buffer;
    ocall_mpi_waitany_args_t* _pargs_out = (ocall_mpi_waitany_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->requests)
        OE_SET_IN_POINTER(requests, _pargs_in->count, sizeof(ocall_mpi_request_t), ocall_mpi_request_t*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->buf)
        OE_SET_OUT_POINTER(buf, _pargs_in->bufcount, sizeof(unsigned char), unsigned char*);
    if (_pargs_in->index)
        OE_SET_OUT_POINTER(index, 1, sizeof(size_t), size_t*);
    if (_pargs_in->status)
        OE_SET_OUT_POINTER(status, 1, sizeof(ocall_mpi_status_t), ocall_mpi_status_t*);

    /* Call user function. */
    _pargs_out->oe_retval = ocall_mpi_waitany(
        _pargs_in->buf,
        _pargs_in->bufcount,
        _pargs_in->count,
        _pargs_in->requests,
...
static void ocall_ocall_mpi_try_wait(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_mpi_try_wait_args_t* _pargs_in = (ocall_mpi_try_wait_args_t*)input_buffer;
    ocall_mpi_try_wait_args_t* _pargs_out = (ocall_mpi_try_wait_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_mpi_try_wait(
        _pargs_in->buf,
        _pargs_in->count,
        _pargs_in->request,
        _pargs_in->flag,
...
static void ocall_ocall_mpi_cancel(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_mpi_cancel_args_t* _pargs_in = (ocall_mpi_cancel_args_t*)input_buffer;
    ocall_mpi_cancel_args_t* _pargs_out = (ocall_mpi_cancel_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_mpi_cancel(
        _pargs_in->request);
...
static void ocall_ocall_mpi_barrier(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_mpi_barrier_args_t* _pargs_in = (ocall_mpi_barrier_args_t*)input_buffer;
    ocall_mpi_barrier_args_t* _pargs_out = (ocall_mpi_barrier_args_t*)output_buffer;
...
static void ocall_ocall_print_string(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_print_string_args_t* _pargs_in = (ocall_print_string_args_t*)input_buffer;
    ocall_print_string_args_t* _pargs_out = (ocall_print_string_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    get_time_args_t* _pargs_in = (get_time_args_t*)input_buffer;
    get_time_args_t* _pargs_out = (get_time_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    init_time_args_t* _pargs_in = (init_time_args_t*)input_buffer;
    init_time_args_t* _pargs_out = (init_time_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    get_time2_args_t* _pargs_in = (get_time2_args_t*)input_buffer;
    get_time2_args_t* _pargs_out = (get_time2_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    init_time2_args_t* _pargs_in = (init_time2_args_t*)input_buffer;
    init_time2_args_t* _pargs_out = (init_time2_args_t*)output_buffer;
...
static oe_ocall_func_t _parallel_ocall_function_table[] = {
    (oe_ocall_func_t) ocall_ocall_mpi_send_bytes,
    (oe_ocall_func_t) ocall_ocall_mpi_recv_bytes,
    (oe_ocall_func_t) ocall_ocall_mpi_try_recv_bytes,
    (oe_ocall_func_t) ocall_ocall_mpi_isend_bytes,
    (oe_ocall_func_t) ocall_ocall_mpi_irecv_bytes,
    (oe_ocall_func_t) ocall_ocall_mpi_wait,
    (oe_ocall_func_t) ocall_ocall_mpi_waitany,
    (oe_ocall_func_t) ocall_ocall_mpi_try_wait,
    (oe_ocall_func_t) ocall_ocall_mpi_cancel,
    (oe_ocall_func_t) ocall_ocall_mpi_barrier,
    (oe_ocall_func_t) ocall_ocall_print_string,
    (oe_ocall_func_t) ocall_get_time,
    (oe_ocall_func_t) ocall_init_time,
    (oe_ocall_func_t) ocall_get_time2,
    (oe_ocall_func_t) ocall_init_time2,
...
oe_result_t oe_create_parallel_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _parallel_ocall_function_table,
               102,
               _parallel_ecall_info_table,
                12,
               enclave);
}
