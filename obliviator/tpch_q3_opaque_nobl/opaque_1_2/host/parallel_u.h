 ...
 */
#ifndef EDGER8R_PARALLEL_U_H
#define EDGER8R_PARALLEL_U_H
...
/**** ECALL prototypes. ****/
oe_result_t ecall_release_threads(oe_enclave_t* enclave);

oe_result_t ecall_unrelease_threads(oe_enclave_t* enclave);

oe_result_t ecall_ojoin_init(
    oe_enclave_t* enclave,
    int* _retval,
    int world_rank,
    int world_size,
...
oe_result_t ecall_ojoin_free_arr(oe_enclave_t* enclave);

oe_result_t ecall_ojoin_free(oe_enclave_t* enclave);

oe_result_t ecall_start_work(oe_enclave_t* enclave);

oe_result_t ecall_scalable_oblivious_join(
    oe_enclave_t* enclave,
    int* _retval,
    char* input_path,
    size_t len);
