...
tpch_require_tables
tpch_prepare_result_dir "tpch_q6_opaque_nobl" "${1:-}"

tpch_run_python_cached \
  "q6_prep_1" \
  "${tpch_artifact_root}/data/TPCH/figure11_q6_1.py" \
  /dev/shm/q6_1.txt
tpch_run_stage "q6_stage_1" "${tpch_artifact_root}/tpch_q6_opaque_nobl/opaque_1" "/dev/shm/q6_1.txt"

tpch_run_python_cached \
  "q6_prep_2" \
  "${tpch_artifact_root}/data/TPCH/figure11_q6_2.py" \
  /dev/shm/q6_2.txt
tpch_run_stage "q6_stage_2" "${tpch_artifact_root}/tpch_q6_opaque_nobl/opaque_2" "/dev/shm/q6_2.txt"
...
tpch_write_summary_header "TPC-H Q6 Opaque NOBL" "${summary_path}"
