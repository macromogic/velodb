...
tpch_require_tables
tpch_prepare_result_dir "tpch_q3_opaque_nobl" "${1:-}"
...
tpch_run_stage "q3_stage_1_1" "${tpch_artifact_root}/tpch_q3_opaque_nobl/opaque_1_1" "/dev/shm/q3_c.txt"
tpch_run_stage "q3_stage_1_2" "${tpch_artifact_root}/tpch_q3_opaque_nobl/opaque_1_2" "/dev/shm/q3_o.txt"
tpch_run_stage "q3_stage_1_3" "${tpch_artifact_root}/tpch_q3_opaque_nobl/opaque_1_3" "/dev/shm/q3_l.txt"

tpch_run_python_cached \
  "q3_prep_1" \
  "${tpch_artifact_root}/data/TPCH/figure11_q3_1.py" \
  /dev/shm/q3_2_1.txt
tpch_run_stage "q3_stage_2" "${tpch_artifact_root}/tpch_q3_opaque_nobl/opaque_2" "/dev/shm/q3_2_1.txt"
...
tpch_run_python_cached \
  ...
  /dev/shm/q3_2_2.txt \
  /dev/shm/q3_2_l.txt
tpch_run_stage "q3_stage_3" "${tpch_artifact_root}/tpch_q3_opaque_nobl/opaque_3" "/dev/shm/q3_2_2.txt"
...
tpch_write_summary_header "TPC-H Q3 Opaque NOBL" "${summary_path}"
