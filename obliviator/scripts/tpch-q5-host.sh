...
source "${script_dir}/tpch-common-host.sh"

tpch_require_tables
tpch_prepare_result_dir "tpch_q5_host" "${1:-}"

tpch_run_python_cached \
  "q5_prep_1" \
  "${tpch_artifact_root}/data/TPCH/figure11_q5_1.py" \
  /dev/shm/q5_1_o.txt
tpch_run_stage "q5_stage_1" "${tpch_artifact_root}/tpch_q5/our_1" "/dev/shm/q5_1_o.txt"

tpch_run_python_cached \
  "q5_prep_2_1" \
  "${tpch_artifact_root}/data/TPCH/figure11_q5_2_1.py" \
  /dev/shm/q5_2_1.txt
tpch_run_stage "q5_stage_2_1" "${tpch_artifact_root}/tpch_q5/our_2" "/dev/shm/q5_2_1.txt"

tpch_run_python_cached \
  "q5_prep_2_2" \
  "${tpch_artifact_root}/data/TPCH/figure11_q5_2_2.py" \
  /dev/shm/q5_2_2.txt
tpch_run_stage "q5_stage_2_2" "${tpch_artifact_root}/tpch_q5/our_2" "/dev/shm/q5_2_2.txt"

tpch_run_python_cached \
  "q5_prep_2_3" \
  "${tpch_artifact_root}/data/TPCH/figure11_q5_2_3.py" \
  /dev/shm/q5_2_3.txt
tpch_run_stage "q5_stage_2_3" "${tpch_artifact_root}/tpch_q5/our_2" "/dev/shm/q5_2_3.txt"

tpch_run_python_cached \
  "q5_prep_2_4" \
  "${tpch_artifact_root}/data/TPCH/figure11_q5_2_4.py" \
  /dev/shm/q5_2_4.txt
tpch_run_stage "q5_stage_2_4" "${tpch_artifact_root}/tpch_q5/our_2" "/dev/shm/q5_2_4.txt"

tpch_run_python_cached \
  "q5_prep_2_5" \
  "${tpch_artifact_root}/data/TPCH/figure11_q5_2_5.py" \
  /dev/shm/q5_2_5.txt
tpch_run_stage "q5_stage_2_5" "${tpch_artifact_root}/tpch_q5/our_2" "/dev/shm/q5_2_5.txt"

tpch_run_python_cached \
  "q5_prep_3" \
  "${tpch_artifact_root}/data/TPCH/figure11_q5_3.py" \
  /dev/shm/q5_3.txt
tpch_run_stage "q5_stage_3" "${tpch_artifact_root}/tpch_q5/our_3" "/dev/shm/q5_3.txt"

tpch_run_python_cached \
  "q5_prep_4" \
  "${tpch_artifact_root}/data/TPCH/figure11_q5_4.py" \
  /dev/shm/q5_4.txt
tpch_run_stage "q5_stage_4" "${tpch_artifact_root}/tpch_q5/our_4" "/dev/shm/q5_4.txt"
...
tpch_write_summary_header "TPC-H Q5 host-only" "${summary_path}"
