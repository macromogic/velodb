...
ojoin_int_type oblivious_compact_elem(elem_t *buf, bool *selected, ojoin_int_type length, ojoin_int_type block_size, ojoin_int_type number_threads, ojoin_int_type* buf_c) {
    
    ojoin_int_type *selected_count = NULL;
    selected_count = buf_c; //calloc((length+1), sizeof(*selected_count));
    selected_count[0] = 0;
