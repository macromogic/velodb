...
BASELINE_CSV="$SCRIPTS_DIR/obliviator_sf$SF.csv"

COMBINED_CSV="$BENCHMARK_DIR/results/sf${SF}_benchmark_comparison.csv"
...
mkdir -p "$FIGURE_DIR"
BENCHMARK_PLOT="$FIGURE_DIR/benchmark_obliv_sf${SF}.pdf"
