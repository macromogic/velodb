...
Value ArithmeticExpression::evaluateJoin(const Tuple* left_tuple, const Schema* left_schema,
    const Tuple* right_tuple, const Schema* right_schema) const
{
    Value left_val = left_->evaluateJoin(left_tuple, left_schema, right_tuple, right_schema);
    Value right_val = right_->evaluateJoin(left_tuple, left_schema, right_tuple, right_schema);
